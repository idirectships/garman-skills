...
### Step 2: Launch Neutral Audit Agent
...
- If any observations warrant deeper investigation → offer to run `bug-hunt` on that component
...
- End with: "X observations flagged for potential follow-up. Want me to run bug-hunt on [component]?"

## Notes

- This skill is best used BEFORE bug-hunt to understand the code before making claims about it
